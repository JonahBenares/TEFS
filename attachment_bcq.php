                                            ...
                                            ?>
                                                <iframe src="<?php 
                                                    if (empty($row1['attach_file'])){
                                                        ...
                                                        if($upload_att == 'jpg' || $upload_att == 'png' || $upload_att == 'jpeg' || $upload_att == 'PNG' || $upload_att == 'JPG' || $upload_att == 'JPEG' || $upload_att == 'pdf' || $upload_att == 'PDF' || $upload_att == 'xlsx' || $upload_att == 'docx' || $upload_att == 'xlsm' || $upload_att == 'xls' || $upload_att == 'xml'){
